<template>
    <div>
      <div class="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col sm:flex-row blog-card-container">
        <!-- section 1 -->
        <div class="mx-auto gap-x-8 border-t border-gray-200 pt-10 lg:mx-0 lg:max-w-none lg:grid-cols-3 px-5 blog-card">
...
@media screen and (max-width:600px) {
    .blog-card{padding-bottom: 2rem;}
    .blog-card-container{padding-bottom: 1rem;}
}
</style>